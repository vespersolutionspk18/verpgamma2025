...
import verp
from verp.accounts.utils import get_currency_precision, get_stock_accounts
from verp.stock.doctype.warehouse.warehouse import get_warehouses_based_on_account


def execute(filters=None):
	if not verp.is_perpetual_inventory_enabled(filters.company):
		frappe.throw(
