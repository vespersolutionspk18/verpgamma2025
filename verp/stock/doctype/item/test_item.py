...
class TestItem(FrappeTestCase):
	...
	def test_get_asset_item_details(self):
		from verp.assets.doctype.asset.test_asset import create_asset_category, create_fixed_asset_item
	...
	def test_check_stock_uom_with_bin_no_sle(self):
		from verp.stock.stock_balance import update_bin_qty
	...
	def test_item_dashboard(self):
		from verp.stock.dashboard.item_dashboard import get_data
	...
	def test_serach_fields_for_item(self):
		from verp.controllers.queries import item_query
