...
from verp.accounts.doctype.gl_entry.gl_entry import rename_gle_sle_docs
...
from verp.stock.doctype.stock_ledger_entry.stock_ledger_entry import BackDatedStockTransaction
