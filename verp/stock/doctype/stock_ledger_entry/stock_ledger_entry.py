...
from verp.controllers.item_variant import ItemTemplateCannotHaveStock
from verp.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
from verp.stock.serial_batch_bundle import SerialBatchBundle
...
class StockLedgerEntry(Document):
	...
	def set_posting_datetime(self, save=False):
		from verp.stock.utils import get_combine_datetime
	...
	def validate_and_set_fiscal_year(self):
		if not self.fiscal_year:
			...
			from verp.accounts.utils import validate_fiscal_year
	...
	def block_transactions_against_group_warehouse(self):
		from verp.stock.utils import is_group_warehouse
