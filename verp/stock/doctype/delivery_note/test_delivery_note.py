...
from verp.stock.doctype.delivery_note.delivery_note import (
	make_delivery_trip,
	make_sales_invoice,
)
from verp.stock.doctype.delivery_trip.test_delivery_trip import create_driver
from verp.stock.doctype.item.test_item import make_item
from verp.stock.doctype.purchase_receipt.test_purchase_receipt import get_gl_entries
...
from verp.stock.stock_ledger import get_previous_sle
...
class TestDeliveryNote(FrappeTestCase):
	...
	def test_delivery_note_return_against_denormalized_serial_no(self):
		from verp.stock.doctype.delivery_note.delivery_note import make_sales_return
	...
	def test_closed_delivery_note(self):
		from verp.stock.doctype.delivery_note.delivery_note import update_delivery_note_status
	...
	def test_dn_billing_status_case3(self):
		...
		from verp.selling.doctype.sales_order.sales_order import make_delivery_note
		from verp.selling.doctype.sales_order.sales_order import (
	...
	def test_dn_billing_status_case4(self):
		# SO -> SI -> DN
		from verp.accounts.doctype.sales_invoice.sales_invoice import make_delivery_note
		from verp.selling.doctype.sales_order.sales_order import make_sales_invoice
	...
	def reserved_qty_check(self):
		from verp.controllers.sales_and_purchase_return import make_return_doc
		from verp.selling.doctype.sales_order.sales_order import make_delivery_note
		from verp.stock.stock_balance import get_reserved_qty
