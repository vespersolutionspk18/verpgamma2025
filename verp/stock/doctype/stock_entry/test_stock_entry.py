...
from verp.stock.doctype.item.test_item import (
	create_item,
	make_item,
	make_item_variant,
...
from verp.stock.doctype.serial_no.serial_no import *
from verp.stock.doctype.stock_entry.stock_entry import FinishedGoodError, make_stock_in_entry
from verp.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
from verp.stock.doctype.stock_ledger_entry.stock_ledger_entry import StockFreezeError
...
from verp.stock.stock_ledger import NegativeStockError, get_previous_sle
...
class TestStockEntry(FrappeTestCase):
	...
	def _test_auto_material_request(
		...
		from verp.stock.reorder_item import reorder_item
	...
	def test_variant_work_order(self):
		...
		from verp.manufacturing.doctype.work_order.work_order import make_stock_entry
	...
	def test_future_negative_sle_batch(self):
		from verp.stock.doctype.batch.test_batch import TestBatch
	...
	def test_mapped_stock_entry(self):
		...
		from verp.stock.doctype.purchase_receipt.purchase_receipt import make_stock_entry
	...
	def test_reposting_for_depedent_warehouse(self):
		from verp.stock.doctype.repost_item_valuation.repost_item_valuation import repost_sl_entries
		from verp.stock.doctype.warehouse.test_warehouse import create_warehouse
	...
	def test_batch_expiry(self):
		from verp.controllers.stock_controller import BatchExpiredError
		from verp.stock.doctype.batch.test_batch import make_new_batch
...
def initialize_records_for_future_negative_sle_test(
	...
	from verp.stock.doctype.batch.test_batch import TestBatch, make_new_batch
	from verp.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
		create_stock_reconciliation,
	)
	from verp.stock.doctype.warehouse.test_warehouse import create_warehouse
