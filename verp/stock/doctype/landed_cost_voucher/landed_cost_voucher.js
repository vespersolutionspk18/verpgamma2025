...
verp.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
verp.stock.LandedCostVoucher = class LandedCostVoucher extends verp.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(verp.stock.LandedCostVoucher);
