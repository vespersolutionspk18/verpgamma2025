...
import verp
from verp.accounts.general_ledger import validate_accounting_period
from verp.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from verp.stock.stock_ledger import (
...
def repost_gl_entries(doc):
	if not cint(verp.is_perpetual_inventory_enabled(doc.company)):
		return
