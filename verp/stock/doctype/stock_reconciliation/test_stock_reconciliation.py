...
# VERP - web based ERP (http://verp.com)
...
from verp.accounts.utils import get_stock_and_account_balance
...
from verp.stock.stock_ledger import get_previous_sle, update_entries_after
from verp.stock.tests.test_utils import StockTestMixin
from verp.stock.utils import get_incoming_rate, get_stock_value_on, get_valuation_method
...
class TestStockReconciliation(FrappeTestCase, StockTestMixin):
	...
	def test_backdated_stock_reco_future_negative_stock(self):
		...
		from verp.stock.stock_ledger import NegativeStockError
