...
from verp.accounts.party import get_due_date_from_template
...
from verp.stock.doctype.material_request.material_request import make_purchase_order
from verp.stock.doctype.material_request.test_material_request import make_material_request
...
class TestPurchaseOrder(FrappeTestCase):
	...
	def test_purchase_order_invoice_receipt_workflow(self):
		from verp.accounts.doctype.purchase_invoice.purchase_invoice import make_purchase_receipt
	...
	def test_warehouse_company_validation(self):
		from verp.stock.utils import InvalidWarehouseCompany

		po = create_purchase_order(company="_Test Company 1", do_not_save=True)
		self.assertRaises(InvalidWarehouseCompany, po.insert)

	def test_uom_integer_validation(self):
		from verp.utilities.transaction_base import UOMMustBeIntegerError
	...
	def test_advance_payment_with_separate_party_account_enabled(self):
		...
		from verp.buying.doctype.purchase_order.purchase_order import make_purchase_invoice
	...
	def test_update_items_for_subcontracting_purchase_order(self):
		from verp.controllers.tests.test_subcontracting_controller import (
