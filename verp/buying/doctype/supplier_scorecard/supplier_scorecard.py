...
from verp.buying.doctype.supplier_scorecard_period.supplier_scorecard_period import (
...
class SupplierScorecard(Document):
	...
	if TYPE_CHECKING:
		...
		from verp.buying.doctype.supplier_scorecard_scoring_standing.supplier_scorecard_scoring_standing import (
