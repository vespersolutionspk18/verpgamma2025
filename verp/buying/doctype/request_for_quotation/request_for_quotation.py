...
from verp.accounts.party import get_party_account_currency, get_party_details
from verp.buying.utils import validate_for_items
from verp.controllers.buying_controller import BuyingController
from verp.stock.doctype.material_request.material_request import set_missing_values
...
class RequestforQuotation(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from verp.buying.doctype.request_for_quotation_item.request_for_quotation_item import (
			RequestforQuotationItem,
		)
		from verp.buying.doctype.request_for_quotation_supplier.request_for_quotation_supplier import (
