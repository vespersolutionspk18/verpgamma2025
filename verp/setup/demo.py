...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "verp")
	try:
		...
		capture("demo_data_creation_failed", "verp", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "verp")
...
def make_transactions(company):
	...
	from verp.accounts.utils import FiscalYearError
