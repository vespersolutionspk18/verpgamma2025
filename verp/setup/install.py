...
from verp.setup.default_energy_point_rules import get_default_energy_point_rules
from verp.setup.doctype.incoterm.incoterm import create_incoterms

from .default_success_action import get_default_success_action

default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://verp.org">VERP</a></div>"""
...
def check_setup_wizard_not_completed():
	if cint(frappe.db.get_single_value("System Settings", "setup_complete") or 0):
		message = """VERP can only be installed on a fresh site where the setup wizard is not completed.
...
def add_standard_navbar_items():
	...
	verp_navbar_items = [
		...
		},
		{
			...
			"item_type": "Route",
			"route": "https://github.com/frappe/verp/issues",
			"is_standard": 1,
		},
	]
...
def add_app_name():
	frappe.db.set_single_value("System Settings", "app_name", "VERP")
