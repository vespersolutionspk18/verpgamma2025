...
from verp.accounts.doctype.accounting_dimension_filter.accounting_dimension_filter import (
	get_dimension_filter_map,
)
from verp.accounts.doctype.accounting_period.accounting_period import ClosedAccountingPeriod
from verp.accounts.doctype.budget.budget import validate_expense_against_budget
from verp.accounts.utils import create_payment_ledger_entry
from verp.exceptions import InvalidAccountDimensionError, MandatoryAccountDimensionError
...
def merge_similar_entries(gl_map, precision=None):
	...
	company = gl_map[0].company if gl_map else verp.get_default_company()
