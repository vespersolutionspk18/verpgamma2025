...
from verp.accounts.doctype.loyalty_program.loyalty_program import validate_loyalty_points
...
class POSInvoice(SalesInvoice):
	...
	if TYPE_CHECKING:
		...
		from verp.accounts.doctype.pos_invoice_item.pos_invoice_item import POSInvoiceItem
		from verp.accounts.doctype.pricing_rule_detail.pricing_rule_detail import PricingRuleDetail
		from verp.accounts.doctype.sales_invoice_advance.sales_invoice_advance import (
			SalesInvoiceAdvance,
		)
		from verp.accounts.doctype.sales_invoice_payment.sales_invoice_payment import (
			SalesInvoicePayment,
		)
