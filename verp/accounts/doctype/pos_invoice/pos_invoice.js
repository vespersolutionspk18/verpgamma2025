...
verp.accounts.pos.setup("POS Invoice");
verp.selling.POSInvoiceController = class POSInvoiceController extends verp.selling.SellingController {
	settings = {};
...
extend_cscript(cur_frm.cscript, new verp.selling.POSInvoiceController({ frm: cur_frm }));
