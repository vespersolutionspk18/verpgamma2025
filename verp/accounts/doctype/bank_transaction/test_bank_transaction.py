...
from verp.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool import (
	get_linked_payments,
	reconcile_vouchers,
)
...
from verp.tests.utils import if_lending_app_installed
...
class TestBankTransaction(FrappeTestCase):
	...
	# This test checks if VERP is able to provide a linked payment for a bank transaction based on the amount of the bank transaction.
	...
	# Check if VERP can correctly filter a linked payments based on the debit/credit amount
...
def create_loan_and_repayment():
	...
	from verp.setup.doctype.employee.test_employee import make_employee
