...
from verp.accounts.doctype.payment_entry.payment_entry import (
	get_company_defaults,
	get_payment_entry,
)
from verp.accounts.doctype.subscription_plan.subscription_plan import get_plan_rate
from verp.accounts.party import get_party_account, get_party_bank_account
from verp.accounts.utils import get_account_currency
from verp.utilities import payment_app_import_guard
...
class PaymentRequest(Document):
	...
	if TYPE_CHECKING:
		...
		from verp.accounts.doctype.subscription_plan_detail.subscription_plan_detail import (
...
def update_payment_req_status(doc, method):
	from verp.accounts.doctype.payment_entry.payment_entry import get_reference_details
