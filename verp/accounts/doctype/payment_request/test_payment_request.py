...
class TestPaymentRequest(unittest.TestCase):
	def setUp(self):
		...
		send_email = patch(
			"verp.accounts.doctype.payment_request.payment_request.PaymentRequest.send_email",
			return_value=None,
		)
		...
		_get_payment_gateway_controller = patch(
			"verp.accounts.doctype.payment_request.payment_request._get_payment_gateway_controller",
		)
	...
	def test_multiple_payment_entries_against_sales_order(self):
		...
		pr1 = make_payment_request(
			dt="Sales Order", dn=so.name, recipient_id="nabin@verp.com", return_doc=1
		)
		pr1.grand_total = 200
		pr1.submit()
