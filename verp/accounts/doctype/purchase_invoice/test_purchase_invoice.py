...
from verp.buying.doctype.purchase_order.purchase_order import get_mapped_purchase_invoice
...
from verp.controllers.accounts_controller import InvalidQtyError, get_payment_terms
from verp.controllers.buying_controller import QtyMismatchError
from verp.exceptions import InvalidCurrency
...
from verp.stock.doctype.stock_entry.test_stock_entry import get_qty_after_transaction
from verp.stock.tests.test_utils import StockTestMixin
...
class TestPurchaseInvoice(FrappeTestCase, StockTestMixin):
	...
	def test_gl_entries_without_perpetual_inventory(self):
		...
		self.assertTrue(not cint(verp.is_perpetual_inventory_enabled(pi.company)))
		pi.insert()
		pi.submit()
	...
	def test_gl_entries_with_perpetual_inventory(self):
		...
		self.assertTrue(cint(verp.is_perpetual_inventory_enabled(pi.company)), 1)
	...
	def test_debit_note(self):
		from verp.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
		from verp.accounts.doctype.sales_invoice.test_sales_invoice import get_outstanding_amount
	...
	def test_offsetting_entries_for_accounting_dimensions(self):
		...
		from verp.accounts.report.trial_balance.test_trial_balance import (
