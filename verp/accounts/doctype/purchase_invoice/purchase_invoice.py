...
from verp.accounts.general_ledger import (
	get_round_off_account_and_cost_center,
	make_gl_entries,
	make_reverse_gl_entries,
	merge_similar_entries,
)
from verp.accounts.party import get_due_date, get_party_account
from verp.accounts.utils import get_account_currency, get_fiscal_year
from verp.assets.doctype.asset.asset import is_cwip_accounting_enabled
from verp.assets.doctype.asset_category.asset_category import get_asset_category_account
from verp.buying.utils import check_on_hold_or_closed_status
from verp.controllers.accounts_controller import validate_account_head
from verp.controllers.buying_controller import BuyingController
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from verp.accounts.doctype.advance_tax.advance_tax import AdvanceTax
		...
		from verp.accounts.doctype.purchase_invoice_advance.purchase_invoice_advance import (
			PurchaseInvoiceAdvance,
		)
		from verp.accounts.doctype.purchase_invoice_item.purchase_invoice_item import PurchaseInvoiceItem
		from verp.accounts.doctype.purchase_taxes_and_charges.purchase_taxes_and_charges import (
			PurchaseTaxesandCharges,
		)
		from verp.accounts.doctype.tax_withheld_vouchers.tax_withheld_vouchers import TaxWithheldVouchers
		from verp.buying.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
	...
	def get_gl_entries(self, warehouse_account=None):
		self.auto_accounting_for_stock = verp.is_perpetual_inventory_enabled(self.company)
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			from verp.stock.doctype.purchase_receipt.purchase_receipt import update_billing_percentage
