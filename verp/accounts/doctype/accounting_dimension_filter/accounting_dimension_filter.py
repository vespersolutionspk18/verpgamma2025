...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from verp.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from verp.accounts.doctype.applicable_on_account.applicable_on_account import (
			ApplicableOnAccount,
		)
