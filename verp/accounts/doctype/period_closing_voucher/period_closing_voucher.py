...
from verp.accounts.utils import get_account_currency, get_fiscal_year, validate_fiscal_year
...
def process_closing_entries(gl_entries, closing_entries, voucher_name, company, closing_date):
	from verp.accounts.doctype.account_closing_balance.account_closing_balance import (
