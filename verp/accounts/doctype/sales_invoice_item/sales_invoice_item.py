...
from verp.assets.doctype.asset.depreciation import get_disposal_account_and_cost_center
from verp.stock.doctype.serial_no.serial_no import get_delivery_note_serial_no, get_serial_nos
