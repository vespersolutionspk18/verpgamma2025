...
from verp.accounts.utils import validate_field_number
...
class CostCenter(NestedSet):
	...
	def autoname(self):
		from verp.accounts.utils import get_autoname_with_number
	...
	def before_rename(self, olddn, newdn, merge=False):
		...
		from verp.setup.doctype.company.company import get_name_with_abbr
