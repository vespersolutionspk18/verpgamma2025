...
import verp
from verp.accounts.doctype.accounting_dimension.accounting_dimension import get_dimensions
from verp.accounts.doctype.bank_account.bank_account import (
	get_bank_account_details,
	get_default_company_bank_account,
	get_party_bank_account,
)
from verp.accounts.doctype.invoice_discounting.invoice_discounting import (
	get_party_account_based_on_invoice_discounting,
)
from verp.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
...
from verp.accounts.party import complete_contact_details, get_party_account, set_contact_details
...
from verp.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from verp.accounts.doctype.advance_taxes_and_charges.advance_taxes_and_charges import (
			AdvanceTaxesandCharges,
		)
		from verp.accounts.doctype.payment_entry_deduction.payment_entry_deduction import (
			PaymentEntryDeduction,
		)
		from verp.accounts.doctype.payment_entry_reference.payment_entry_reference import (
	...
	def set_payment_req_status(self):
		from verp.accounts.doctype.payment_request.payment_request import update_payment_req_status
...
def get_reference_details(
	...
	company_currency = ref_doc.get("company_currency") or verp.get_company_currency(ref_doc.company)
