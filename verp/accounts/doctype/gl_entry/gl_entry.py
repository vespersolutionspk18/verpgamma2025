...
from verp.accounts.party import validate_party_frozen_disabled, validate_party_gle_currency
...
class GLEntry(Document):
	...
	def validate_currency(self):
		company_currency = verp.get_company_currency(self.company)
...
def update_against_account(voucher_type, voucher_no):
	...
	if not entries:
		return
	company_currency = verp.get_company_currency(entries[0].company)
