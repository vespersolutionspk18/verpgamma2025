...
class OpeningInvoiceCreationTool(Document):
	...
	if TYPE_CHECKING:
		...
		from verp.accounts.doctype.opening_invoice_creation_tool_item.opening_invoice_creation_tool_item import (
		...
		invoice = frappe._dict(
			{
				...
				"update_stock": 0,  # important: https://github.com/frappe/verp/pull/23559
