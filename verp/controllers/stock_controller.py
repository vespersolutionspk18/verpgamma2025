...
from verp.accounts.utils import cancel_exchange_gain_loss_journal, get_fiscal_year
from verp.controllers.accounts_controller import AccountsController
from verp.controllers.sales_and_purchase_return import (
...
from verp.stock.doctype.inventory_dimension.inventory_dimension import (
	get_evaluated_inventory_dimension,
)
from verp.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import (
	get_type_of_transaction,
)
from verp.stock.stock_ledger import get_items_to_be_repost
...
class StockController(AccountsController):
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		...
		if (
			cint(verp.is_perpetual_inventory_enabled(self.company))
	...
	def clean_serial_nos(self):
		from verp.stock.doctype.serial_no.serial_no import clean_serial_no_string
	...
	def make_sl_entries(self, sl_entries, allow_negative_stock=False, via_landed_cost_voucher=False):
		from verp.stock.stock_ledger import make_sl_entries
	...
	def validate_warehouse(self):
		from verp.stock.utils import validate_disabled_warehouse, validate_warehouse_company
	...
	def validate_putaway_capacity(self):
		...
		from verp.stock.doctype.putaway_rule.putaway_rule import get_available_putaway_capacity
...
def get_accounting_ledger_preview(doc, filters):
	from verp.accounts.report.general_ledger.general_ledger import get_columns as get_gl_columns
...
def get_stock_ledger_preview(doc, filters):
	from verp.stock.report.stock_ledger.stock_ledger import get_columns as get_sl_columns
