...
import verp
from verp.accounts.doctype.journal_entry.journal_entry import get_exchange_rate
from verp.accounts.doctype.pricing_rule.utils import get_applied_pricing_rules
from verp.controllers.accounts_controller import (
	validate_conversion_rate,
	validate_inclusive_tax,
	validate_taxes_and_charges,
)
from verp.stock.get_item_details import _get_item_tax_template
...
class calculate_taxes_and_totals:
	...
	def validate_conversion_rate(self):
		...
		company_currency = verp.get_company_currency(self.doc.company)
