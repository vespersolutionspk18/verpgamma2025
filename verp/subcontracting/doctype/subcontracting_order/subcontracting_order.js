...
verp.landed_cost_taxes_and_charges.setup_triggers("Subcontracting Order");
...
frappe.ui.form.on("Subcontracting Order", {
	...
	update_subcontracting_order_status(frm, status) {
		frappe.call({
			method: "verp.subcontracting.doctype.subcontracting_order.subcontracting_order.update_subcontracting_order_status",
			args: {
				sco: frm.doc.name,
				status: status,
			},
...
verp.buying.SubcontractingOrderController = class SubcontractingOrderController {
	setup() {
	...
	make_subcontracting_receipt() {
		frappe.model.open_mapped_doc({
			method: "verp.subcontracting.doctype.subcontracting_order.subcontracting_order.make_subcontracting_receipt",
			frm: cur_frm,
...
extend_cscript(cur_frm.cscript, new verp.buying.SubcontractingOrderController({ frm: cur_frm }));
