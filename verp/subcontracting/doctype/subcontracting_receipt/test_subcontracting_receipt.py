...
class TestSubcontractingReceipt(FrappeTestCase):
	...
	def test_subcontracting_over_receipt(self):
		...
		"""
		from verp.controllers.subcontracting_controller import (
	...
	def test_subcontracting_receipt_over_return(self):
		...
		from verp.controllers.status_updater import OverAllowanceError
	...
	def test_subcontracting_receipt_gl_entry(self):
		...
		self.assertEqual(cint(verp.is_perpetual_inventory_enabled(scr.company)), 1)
	...
	def test_quality_inspection_for_subcontracting_receipt(self):
		from verp.stock.doctype.quality_inspection.test_quality_inspection import (
