...
from verp.accounts.party import get_due_date
from verp.exceptions import PartyDisabled, PartyFrozen
from verp.selling.doctype.customer.customer import (
	get_credit_limit,
	get_customer_outstanding,
	parse_full_name,
)
from verp.tests.utils import create_test_contact_and_address
...
class TestCustomer(FrappeTestCase):
	...
	def test_party_details(self):
		from verp.accounts.party import get_party_details
	...
	def test_customer_credit_limit_after_submit(self):
		from verp.controllers.accounts_controller import update_child_qty_rate
		from verp.selling.doctype.sales_order.test_sales_order import make_sales_order
