...
class TestQuotation(FrappeTestCase):
	...
	def test_make_sales_order_terms_copied(self):
		from verp.selling.doctype.quotation.quotation import make_sales_order
	...
	def test_gross_profit(self):
		...
		from verp.stock.get_item_details import insert_item_price
	...
	def test_quotation_expiry(self):
		from verp.selling.doctype.quotation.quotation import set_expired_status
