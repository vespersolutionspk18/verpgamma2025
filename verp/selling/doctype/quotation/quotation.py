...
class Quotation(SellingController):
	...
	if TYPE_CHECKING:
		...
		from verp.crm.doctype.competitor_detail.competitor_detail import CompetitorDetail
		from verp.selling.doctype.quotation_item.quotation_item import QuotationItem
		from verp.setup.doctype.quotation_lost_reason_detail.quotation_lost_reason_detail import (
...
def create_customer_from_lead(lead_name, ignore_permissions=False):
	from verp.crm.doctype.lead.lead import _make_customer
