...
def task(doc_name, from_doctype, to_doctype):
	from verp.accounts.doctype.payment_entry import payment_entry
	from verp.accounts.doctype.purchase_invoice import purchase_invoice
	from verp.accounts.doctype.sales_invoice import sales_invoice
	from verp.buying.doctype.purchase_order import purchase_order
	from verp.buying.doctype.supplier_quotation import supplier_quotation
	from verp.selling.doctype.quotation import quotation
	from verp.selling.doctype.sales_order import sales_order
	from verp.stock.doctype.delivery_note import delivery_note
	from verp.stock.doctype.purchase_receipt import purchase_receipt
