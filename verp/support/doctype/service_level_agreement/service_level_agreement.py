...
class ServiceLevelAgreement(Document):
	...
	if TYPE_CHECKING:
		...
		from verp.support.doctype.pause_sla_on_status.pause_sla_on_status import PauseSLAOnStatus
		from verp.support.doctype.service_day.service_day import ServiceDay
		from verp.support.doctype.service_level_priority.service_level_priority import (
			ServiceLevelPriority,
		)
		from verp.support.doctype.sla_fulfilled_on_status.sla_fulfilled_on_status import (
