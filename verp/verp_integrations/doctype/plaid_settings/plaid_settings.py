...
from verp.verp_integrations.doctype.plaid_settings.plaid_connector import PlaidConnector
...
def enqueue_synchronization():
	...
	for plaid_account in plaid_accounts:
		frappe.enqueue(
			"verp.verp_integrations.doctype.plaid_settings.plaid_settings.sync_transactions",
