...
from verp.projects.doctype.project_template.test_project_template import make_project_template
from verp.projects.doctype.task.test_task import create_task
from verp.selling.doctype.sales_order.sales_order import make_project as make_project_from_so
