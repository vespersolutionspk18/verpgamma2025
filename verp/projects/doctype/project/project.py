...
from verp import get_default_company
from verp.controllers.queries import get_filters_cond
from verp.controllers.website_list_for_contact import get_customers_suppliers
from verp.setup.doctype.holiday_list.holiday_list import is_holiday
...
class Project(Document):
	...
	if TYPE_CHECKING:
		...
		from verp.projects.doctype.project_user.project_user import ProjectUser
