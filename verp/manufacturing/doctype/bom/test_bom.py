...
from verp.manufacturing.doctype.bom.bom import BOMRecursionError, item_query, make_variant_bom
from verp.manufacturing.doctype.bom_update_log.test_bom_update_log import (
...
class TestBOM(FrappeTestCase):
	...
	def test_get_items_list(self):
		from verp.manufacturing.doctype.bom.bom import get_bom_items
	...
	def test_do_not_include_manufacturing_and_fixed_items(self):
		from verp.manufacturing.doctype.bom.bom import item_query
