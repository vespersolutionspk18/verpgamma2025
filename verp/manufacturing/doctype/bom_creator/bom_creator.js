...
frappe.ui.form.on("BOM Creator", {
	...
	make_new_entry(frm) {
		...
		dialog.fields_dict.item_code.get_query = "verp.controllers.queries.item_query";
		dialog.show();
	},
...
verp.bom.BomConfigurator = class BomConfigurator extends verp.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new verp.bom.BomConfigurator({ frm: cur_frm }));
