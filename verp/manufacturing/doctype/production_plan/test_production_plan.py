...
from verp.manufacturing.doctype.work_order.work_order import make_stock_entry as make_se_from_wo
...
class TestProductionPlan(FrappeTestCase):
	...
	def test_production_plan_for_subcontracting_po(self):
		from verp.manufacturing.doctype.bom.test_bom import create_nested_bom
		from verp.subcontracting.doctype.subcontracting_bom.test_subcontracting_bom import (
