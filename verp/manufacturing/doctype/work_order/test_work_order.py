...
from verp.manufacturing.doctype.job_card.job_card import JobCardCancelError
...
from verp.stock.doctype.stock_entry import test_stock_entry
...
class TestWorkOrder(FrappeTestCase):
	...
	def test_wo_completion_with_pl_bom(self):
		from verp.manufacturing.doctype.bom.test_bom import (
	...
	def test_auto_batch_creation(self):
		from verp.manufacturing.doctype.bom.test_bom import create_nested_bom
...
def prepare_data_for_workstation_type_check():
	from verp.manufacturing.doctype.operation.test_operation import make_operation
	from verp.manufacturing.doctype.workstation.test_workstation import make_workstation
	from verp.manufacturing.doctype.workstation_type.test_workstation_type import (
