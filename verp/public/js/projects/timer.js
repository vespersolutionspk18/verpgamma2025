frappe.provide("verp.timesheet");

verp.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	verp.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

verp.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
