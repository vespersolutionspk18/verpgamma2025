(() => {
  ...
  erpnext.SerialBatchPackageSelector = class SerialNoBatchBundleUpdate {
    ...
    make() {
      ...
      if (((_b = this.item) == null ? void 0 : _b.has_serial_no) && ((_c = this.item) == null ? void 0 : _c.batch_no)) {
    ...
    get_warehouse() {
      var _a;
      return ((_a = this.item) == null ? void 0 : _a.type_of_transaction) === "Outward" ? this.item.warehouse || this.item.s_warehouse : this.item.warehouse || this.item.t_warehouse;
    }
    render_data() {
      if (this.bundle) {
        frappe.call({
  ...
  // frappe-html:/Users/mac/frp-bench/apps/erpnext/erpnext/public/js/templates/visual_plant_floor_template.html
...
{% }); %}`;
  ...
  erpnext.taxes_and_totals = class TaxesAndTotals extends erpnext.payments {
    ...
    calculate_totals() {
      ...
      this.frm.doc.grand_total = flt(tax_count ? this.frm.doc["taxes"][tax_count - 1].total + flt(this.frm.doc.grand_total_diff) : this.frm.doc.net_total);
  ...
  erpnext.TransactionController = class TransactionController extends erpnext.taxes_and_totals {
    ...
    setup_sms() {
      ...
      if (this.frm.doc.docstatus === 1 && !["Lost", "Stopped", "Closed"].includes(this.frm.doc.status) && !blacklist.includes(this.frm.doctype)) {
      ...
      var set_pricing = function() {
        if (me.frm.doc.company && me.frm.fields_dict.currency) {
          ...
          if (company_doc) {
            ...
            if (company_doc.default_selling_terms && frappe.meta.has_field(me.frm.doc.doctype, "tc_name") && selling_doctypes_for_tc.includes(me.frm.doc.doctype) && !me.frm.doc.tc_name) {
            ...
            if (company_doc.default_buying_terms && frappe.meta.has_field(me.frm.doc.doctype, "tc_name") && buying_doctypes_for_tc.includes(me.frm.doc.doctype) && !me.frm.doc.tc_name) {
    ...
    due_date() {
      var _a, _b;
      if (this.frm.doc.due_date && !this.frm.updating_party_details && !this.frm.doc.is_pos && (this.frm.doc.payment_terms_template || ((_a = this.frm.doc.payment_schedule) == null ? void 0 : _a.length))) {
        const to_clear = [];
        if (this.frm.doc.payment_terms_template) {
          to_clear.push("Payment Terms Template");
        }
        if ((_b = this.frm.doc.payment_schedule) == null ? void 0 : _b.length) {
  ...
  // frappe-html:/Users/mac/frp-bench/apps/erpnext/erpnext/public/js/templates/item_selector.html
...
`;
  ...
  // frappe-html:/Users/mac/frp-bench/apps/erpnext/erpnext/public/js/templates/item_quick_entry.html
...
`;
  ...
  erpnext.accounts.unreconcile_payment = {
    add_unreconcile_btn(frm) {
      if (frm.doc.docstatus == 1) {
        if (frm.doc.doctype == "Journal Entry" && frm.doc.voucher_type != "Journal Entry" || !["Purchase Invoice", "Sales Invoice", "Journal Entry", "Payment Entry"].includes(
          frm.doc.doctype
        )) {
          return;
        }
  ...
  // frappe-html:/Users/mac/frp-bench/apps/erpnext/erpnext/public/js/templates/call_link.html
...
`;
  ...
  // frappe-html:/Users/mac/frp-bench/apps/erpnext/erpnext/public/js/templates/crm_activities.html
...
.form-footer {
  ...
  // frappe-html:/Users/mac/frp-bench/apps/erpnext/erpnext/public/js/templates/crm_notes.html
...
//# sourceMappingURL=erpnext.bundle.N6VLUSUG.js.map
